...
pub use lower::{
    ...
    parse_discovered_module_with_options, parse_discovered_module_with_prefix,
    parse_locale_pending, parse_module, parse_module_with_options, parse_module_with_prefix,
