...
use factorio_ir::{module::Module, statement::Statement, stage::Stage};
...
pub fn generate_control_lua(mod_name: &str, events: &[EventRegistration]) -> String {
    let mut output = String::from("-- Generated by cargo-factorio\n");
    if events.is_empty() {
...
pub fn generate_info_json(
    ...
    let factorio_version = mod_config
        .factorio_version
        .as_deref()
        .unwrap_or("2.0");
...
mod tests {
    use factorio_ir::{
        block::Block, function::Function, module::{Module, Symbol}, scope::Scope,
        stage::Stage, statement::Statement,
    };
